...
public class Client extends JFrame {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(() -> {
            ...
            client.setLocation(Toolkit.getDefaultToolkit().getScreenSize().width - client.getWidth(),
                    Toolkit.getDefaultToolkit().getScreenSize().height / 2 - client.getHeight() / 2);
        });
    }
        ...
        getInfoButton.addActionListener((event) -> {
            try {
                ...
                JOptionPane.showMessageDialog(this,
                        "Could not get information ", "Error", 0);
            }
        });
        ...
        MainPanelLayout.setHorizontalGroup(MainPanelLayout.createParallelGroup(GroupLayout.Alignment.LEADING).
                addGroup(MainPanelLayout.createSequentialGroup().
                        ...
                        addGroup(MainPanelLayout.createParallelGroup(GroupLayout.Alignment.LEADING).
                                addGroup(MainPanelLayout.createSequentialGroup().addComponent(labelHost).
                                        addGap(18, 18, 18).
                                        addComponent(this.hostTextField, -2, 75, -2).
                                        addGap(18, 18, 18).
                                        addComponent(labelPort).addGap(18, 18, 18).
                                        addComponent(this.portTextField, -2, 57, -2).
                                        addGap(18, 18, 18).
                                        addComponent(labelParticipants).
                                        addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).
                                        addComponent(this.participantsTextField, -2, 34, -2)).
                                addGroup(MainPanelLayout.createSequentialGroup().
                                        addGroup(MainPanelLayout.createParallelGroup(GroupLayout.Alignment.LEADING).
                                        ...
                                        addGroup(MainPanelLayout.createParallelGroup(GroupLayout.Alignment.LEADING, false).
                                                ...
                                                addComponent(this.organizationTextField).
                                                addComponent(this.reportTextField, -1, 248, 32767).
                                                addComponent(this.emailTextField)))).
        ...
        MainPanelLayout.setVerticalGroup(MainPanelLayout.createParallelGroup(GroupLayout.Alignment.LEADING).
                addGroup(MainPanelLayout.createSequentialGroup().
                        ...
                        addGroup(MainPanelLayout.createParallelGroup(GroupLayout.Alignment.BASELINE).
                                ...
                                addComponent(this.hostTextField, -2, -1, -2).
                                addComponent(labelPort).
                                addComponent(this.portTextField, -2, -1, -2).
                                addComponent(labelParticipants).
                                addComponent(this.participantsTextField, -2, -1, -2)).
                        addGap(26, 26, 26).
                        addGroup(MainPanelLayout.createParallelGroup(GroupLayout.Alignment.BASELINE).
                                addComponent(labelName).addComponent(this.nameTextField, -2, -1, -2)).
                        addGap(18, 18, 18).
                        addGroup(MainPanelLayout.createParallelGroup(GroupLayout.Alignment.BASELINE).
                                addComponent(labelSurname).addComponent(this.surnameTextField, -2, -1, -2)).
                        addGap(18, 18, 18).
                        addGroup(MainPanelLayout.createParallelGroup(GroupLayout.Alignment.BASELINE).
                                addComponent(labelOrganization).
                                addComponent(this.organizationTextField, -2, -1, -2)).
                        addGap(18, 18, 18).
                        addGroup(MainPanelLayout.createParallelGroup(GroupLayout.Alignment.BASELINE).
                                addComponent(labelReport).
                                addComponent(this.reportTextField, -2, -1, -2)).
                        addGap(18, 18, 18).
                        addGroup(MainPanelLayout.createParallelGroup(GroupLayout.Alignment.BASELINE).
                                addComponent(labelEmail).
                                addComponent(this.emailTextField, -2, -1, -2)).
                        addContainerGap(-1, 32767)));
        GroupLayout layout = new GroupLayout(this.getContentPane());
        this.getContentPane().setLayout(layout);
        layout.setHorizontalGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).
                addComponent(buttonPanel, -1, -1, 32767).
                addComponent(mainPanel, -1, -1, 32767));
        layout.setVerticalGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).
                addGroup(GroupLayout.Alignment.TRAILING, layout.createSequentialGroup().
                        addComponent(mainPanel, -1, -1, 32767).
                        addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).
                        addComponent(buttonPanel, -2, -1, -2)));
    ...
    private void registerParticipant() throws NumberFormatException, RemoteException, NotBoundException {
        try {
            ...
            Registry registry = LocateRegistry.getRegistry(this.hostTextField.getText(),
            ...
            JOptionPane.showMessageDialog(this, "Thank you for registration", "Successful", 1);
