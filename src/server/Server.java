    ...
    private void initComponents() {
        ...
        startButton.addActionListener(event -> {
            try {
                ...
                JOptionPane.showMessageDialog(Server.this,
                        "Server successfully started", "Successful", JOptionPane.INFORMATION_MESSAGE);
            } catch (RemoteException e) {
                JOptionPane.showMessageDialog(Server.this, "Server failed to start",
        ...
        stopButton.addActionListener(event -> {
            try {
                stopServer();
                JOptionPane.showMessageDialog(Server.this,
                        "Server successfully stopped", "Successful", JOptionPane.INFORMATION_MESSAGE);
            } catch (NumberFormatException | RemoteException | NotBoundException e) {
                JOptionPane.showMessageDialog(Server.this,
                        "Server failed to stop", "Error", JOptionPane.ERROR_MESSAGE);
            }
        });
        ...
        saveButton.addActionListener(event -> {
            if (JFileChooser.APPROVE_OPTION == fileChooser.showDialog(null, "Save")) {
                ...
                try {
                    ...
                    JOptionPane.showMessageDialog(Server.this,
                            "Saved", "Error", JOptionPane.INFORMATION_MESSAGE);
        ...
        loadButton.addActionListener(event -> {
            if (JFileChooser.APPROVE_OPTION == fileChooser.showOpenDialog(null)) {
                ...
                try {
                    ...
                    JOptionPane.showMessageDialog(Server.this,
                            "Failed to load", "Error", JOptionPane.ERROR_MESSAGE);
                    e.printStackTrace();
                }
